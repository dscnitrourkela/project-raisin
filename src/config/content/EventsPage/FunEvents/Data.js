export const FunData = [
  ...
  },
  {
    ...
    Description:
      'Can you crack the code? Test your detective skills and try to identify the mystery character hidden inside the box. Are you ready to take on the challenge?',
    Location: 'TBA',
    Date: 'TBA',
    Time: 'TBA',
    Prizes: 'TBA',
  },
  {
    ...
    Description:
      'Get ready for an epic battle! Grab your blaster and compete in intense, action-packed matches. Show off your skills and emerge victorious in this thrilling event. Time: 9-5 Day : All three days',
    Location: 'TBA',
    Date: 'TBA',
    Time: 'TBA',
    Prizes: 'TBA',
  },
  {
    ...
    Description:
      'Are you ready to showcase your cricketing skills? Join us for an exciting box cricket tournament. Assemble your team and compete for the championship. Let the games begin!',
    Location: 'TBA',
    Date: 'TBA',
    Time: 'TBA',
    Prizes: 'TBA',
  },
  {
    ...
    Description:
      'Unleash your inner archer at Innovision 2024! Test your aim and have fun with soft-tipped arrows. Whether you are a seasoned pro or a beginner, this exciting event offers a unique experience for all.',
    Location: 'TBA',
    Date: 'TBA',
    Time: 'TBA',
    Prizes: 'TBA',
  },
  {
    ...
    Description:
      'Test your aim and accuracy in our fun-filled balloon shooting challenge. See how many balloons you can pop in a given time. Compete against friends and family and aim for the top spot!',
    Location: 'TBA',
    Date: 'TBA',
    Time: 'TBA',
    Prizes: 'TBA',
  },
  {
    ...
    Description:
      'Calling all Tic-Tac-Toe enthusiasts! Join us for a thrilling tournament at Innovision. Show off your strategic skills and compete against fellow players in this fun-filled event. Whether you are a seasoned pro or just starting out, everyone is welcome to participate.',
    Location: 'TBA',
    Date: 'TBA',
    Time: 'TBA',
    Prizes: 'TBA',
  },
  {
    ...
    Description:
      'Get ready for a thrilling adventure! Experience the joy of body zorbing, a fun and exciting activity where you roll around in a giant inflatable ball. Bounce, bump, and have a blast with your friends and family. It is a perfect way to add some excitement to your day!',
    Location: 'TBA',
    Date: 'TBA',
    Time: 'TBA',
    Prizes: 'TBA',
