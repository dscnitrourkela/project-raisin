...
export const PreviewCardContainer = styled.div`
  ${tw`w-full h-auto max-w-[280px]  xxxs:max-h-[480px] xsm:max-w-[350px] xsm:max-h-[600px] xl:max-w-[460px] xl:h-[605.6px] bg-gradient-to-b from-[#002929] to-[#22002b] rounded-lg shadow-lg border border-[#074870] flex flex-col justify-between items-center p-6 mb-16 gap-y-4`}
  ...
  &:hover {
    ...
    box-shadow:
      0 0 25px 6px rgba(255, 255, 255, 0.5),
      0 0 10px 4px rgba(255, 0, 127, 0.5);
  }
`;
