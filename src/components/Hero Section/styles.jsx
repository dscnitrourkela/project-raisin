...
export const HeroLogoText = styled.h1`
  ${tw`text-[65px] 2xs:text-[70px] sm:text-[100px] md:text-[130px] lg:text-[170px] not-italic font-normal font-techno text-[#FFFFFFE6] tracking-wider`}
`;

export const HeroSubLogoText = styled.h1`
  ${tw`text-[60px] 2xs:text-[55px] sm:text-[80px] md:text-[110px] lg:text-[150px] not-italic font-normal font-techno text-transparent`}
