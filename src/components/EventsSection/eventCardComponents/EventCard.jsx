  ...
  return (
    <>
      <div
        ...
        className=' w-[270px] xxsm:w-[310px] xsm:w-[347px] h-[360px] xsm:h-[416px]  flex justify-center items-center text-[24px] font-spaceX leading-[37px] break-words text-center rounded-3xl'
      >
